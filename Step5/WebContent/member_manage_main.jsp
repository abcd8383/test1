			...
			$.ajax({
				...
				success : function(d) {
					...
					for(i=0;i<json.result.length;i++){
						//한건당 한줄씩 표현
						txt += "<tr><td>"+json.result[i].id +"<input type='hidden' name='id' value='"+json.result[i].id+"'></td>"
						+"<td><input type='text' name='name' value='"+json.result[i].name+"'></td>"
						+"<td><input type='text' name='name' value='"+json.result[i].age+"'></td>"
						+"<td><input type='text' name='name' value='"+json.result[i].grade+"'></td>"
